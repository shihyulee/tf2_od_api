...
tfrecord_train = "python myproject/generate_tfrecord.py -x {} -l {} -o {}".format(
    TRAIN_XML_FILE, LABEL_MAP_FILE, TRAIN_TF_RECORD_DIR)
tfrecord_test = "python myproject/generate_tfrecord.py -x {} -l {} -o {}".format(
    TEST_XML_FILE, LABEL_MAP_FILE, TEST_TF_RECORD_DIR)
